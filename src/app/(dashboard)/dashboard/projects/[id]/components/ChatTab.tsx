...
export default function ChatTab({ project }: Props) {
  ...
  return (
    <div className="flex flex-col h-[560px] border border-[#5B5F73]/20 bg-[#EFEDE8] rounded-2xl shadow-sm overflow-hidden">
      ...
      {/* Message Input */}
      <div className="p-4 border-t border-[#5B5F73]/15 dark:border-[#252A3D] bg-white dark:bg-[#161926]">
        <form onSubmit={handleSend} className="flex gap-2">
          <input
            ...
            className="flex-1 bg-[#EFEDE8] dark:bg-[#1A1E2E] border border-[#5B5F73]/20 dark:border-[#2E3350] rounded-xl px-4 py-2.5 text-sm text-[#1C1C1E] dark:text-[#F3F4F6] focus:outline-none focus:border-[#9C7A4C]"
          />
          <Button type="submit" disabled={!newMessage.trim()} className="bg-[#1C1C1E] dark:bg-[#9C7A4C] text-white hover:bg-black dark:hover:bg-[#7A6039] px-5 rounded-xl">
