...
export function ProblemFitPanel({ problem }: { problem: Problem }) {
  ...
  let badgeColorClass = "bg-amber-100 text-amber-900 border-amber-300";
  let ringClass = "border-amber-400";
  let lightBgClass = "bg-amber-50/70";

  if (fit.score >= 70) {
    matchLabel = "Strong Match";
    badgeColorClass = "bg-emerald-100 text-emerald-900 border-emerald-300";
    ringClass = "border-emerald-400";
    lightBgClass = "bg-emerald-50/70";
  } else if (fit.score >= 50) {
    matchLabel = "Good Match";
    badgeColorClass = "bg-[#9C7A4C]/15 text-[#7A6039] border-[#9C7A4C]/30";
    ringClass = "border-[#9C7A4C]/40";
